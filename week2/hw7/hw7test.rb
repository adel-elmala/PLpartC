...
d4 = d.intersect(LineSegment.new(-THREE,-FOUR,ONE,TWO).preprocess_prog)
...
tests[24] = equal(Shift.new(ONE, TWO, LineSegment.new(ONE, ONE, THREE, THREE)).preprocess_prog.eval_prog([]), LineSegment.new(FOUR, FIVE, TWO, THREE))
...
tests[34] = equal(Let.new("x", LineSegment.new(TWO, TWO, ONE, ONE), Var.new("x")).preprocess_prog.eval_prog([]), LineSegment.new(TWO, TWO, ONE, ONE))
...
tests[61] = equal(Intersect.new(Line.new(ONE, ZERO), LineSegment.new(ZERO, ZERO, FOUR, FOUR)).preprocess_prog.eval_prog([]), LineSegment.new(FOUR, FOUR, ZERO, ZERO))
...
tests[65] = equal(Intersect.new(VerticalLine.new(ONE), LineSegment.new(ONE, ZERO, ONE, FOUR)).preprocess_prog.eval_prog([]), LineSegment.new(ONE, FOUR, ONE, ZERO))
...
tests[73] = equal(Intersect.new(LineSegment.new(ZERO, ZERO, ZERO, FOUR), LineSegment.new(ZERO, ONE, ZERO, THREE)).preprocess_prog.eval_prog([]), LineSegment.new(ZERO, THREE, ZERO, ONE))
tests[74] = equal(Intersect.new(LineSegment.new(ZERO, ONE, ZERO, THREE), LineSegment.new(ZERO, ZERO, ZERO, FOUR)).preprocess_prog.eval_prog([]), LineSegment.new(ZERO, THREE, ZERO, ONE))
tests[75] = equal(Intersect.new(LineSegment.new(ZERO, ONE, ZERO, THREE), LineSegment.new(ZERO, ONE, ZERO, THREE)).preprocess_prog.eval_prog([]), LineSegment.new(ZERO, THREE, ZERO, ONE))
tests[76] = equal(Intersect.new(LineSegment.new(ZERO, ZERO, ZERO, THREE), LineSegment.new(ZERO, ONE, ZERO, FOUR)).preprocess_prog.eval_prog([]), LineSegment.new(ZERO, THREE, ZERO, ONE))
...
tests[122] = Intersect.new(LineSegment.new(ONE, ONE, FOUR, FOUR), LineSegment.new(TWO, TWO, THREE, THREE)).preprocess_prog.eval_prog([]) == LineSegment.new(THREE, THREE, TWO, TWO) 
tests[123] = Intersect.new(LineSegment.new(ONE, ONE, FOUR, FOUR), LineSegment.new(-ONE, -ONE, THREE, THREE)).preprocess_prog.eval_prog([]) == LineSegment.new(THREE, THREE, ONE, ONE)
tests[124] = Intersect.new(LineSegment.new(ONE, ONE, FOUR, FOUR), LineSegment.new(TWO, TWO, FIVE, FIVE)).preprocess_prog.eval_prog([]) == LineSegment.new(FOUR, FOUR, TWO, TWO)
tests[125] = Intersect.new(LineSegment.new(ONE, ONE, FOUR, FOUR), LineSegment.new(FOUR, FOUR, FIVE, FIVE)).preprocess_prog.eval_prog([]) == Point.new(FOUR, FOUR)
tests[126] = Intersect.new(LineSegment.new(ONE, ONE, FOUR, FOUR), LineSegment.new(-FOUR, -FOUR, ONE, ONE)).preprocess_prog.eval_prog([]) == Point.new(ONE, ONE)
tests[127] = Intersect.new(LineSegment.new(TWO, TWO, THREE, THREE), LineSegment.new(ONE, ONE, FIVE, FIVE)).preprocess_prog.eval_prog([]) == LineSegment.new(THREE, THREE, TWO, TWO)

# intersection between two vertical LineSegments
tests[128] = Intersect.new(LineSegment.new(ONE, ONE, ONE, FOUR), LineSegment.new(ONE, 4.1, ONE, FIVE)).preprocess_prog.eval_prog([]).class == NoPoints.new.class
tests[129] = Intersect.new(LineSegment.new(ONE, ONE, ONE, FOUR), LineSegment.new(ONE, TWO, ONE, THREE)).preprocess_prog.eval_prog([]) == LineSegment.new(ONE, THREE, ONE, TWO)
tests[130] = Intersect.new(LineSegment.new(ONE, ONE, ONE, FOUR), LineSegment.new(ONE, -ONE, ONE, THREE)).preprocess_prog.eval_prog([]) == LineSegment.new(ONE, THREE, ONE, ONE)
tests[131] = Intersect.new(LineSegment.new(ONE, ONE, ONE, FOUR), LineSegment.new(ONE, TWO, ONE, FIVE)).preprocess_prog.eval_prog([]) == LineSegment.new(ONE, FOUR, ONE, TWO)
tests[132] = Intersect.new(LineSegment.new(ONE, ONE, ONE, FOUR), LineSegment.new(ONE, FOUR, ONE, FIVE)).preprocess_prog.eval_prog([]) == Point.new(ONE, FOUR)
tests[133] = Intersect.new(LineSegment.new(ONE, ONE, ONE, FOUR), LineSegment.new(ONE, -FOUR, ONE, ONE)).preprocess_prog.eval_prog([]) == Point.new(ONE, ONE)
tests[134] = Intersect.new(LineSegment.new(ONE, TWO, ONE, THREE), LineSegment.new(ONE, ONE, ONE, FIVE)).preprocess_prog.eval_prog([]) == LineSegment.new(ONE, THREE, ONE, TWO)
