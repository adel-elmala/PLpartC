...
(* More Exhaustive Preprocessor Tests *)
let
...
in
    if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
    then (print "preprocess_prog with LineSegment x1 > x2 by 0.00000999 working properly\n")
    else (print "! preprocess_prog with LineSegment x1 > x2 by 0.00000999 not working properly\n")
end;